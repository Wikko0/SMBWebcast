<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ (Request::is('admin/meeting')) || (Request::is('admin/join')) || (Request::is('admin/meeting/history'))  ? 'active' : '' }}" >
        ...
        <div id="collapseMeeting" class="collapse {{ (Request::is('admin/meeting')) || (Request::is('admin/join')) || (Request::is('admin/meeting/history')) ? 'show' : '' }}" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ (Request::is('admin/meeting')) ? 'active' : '' }}" href="/admin/meeting">All Meeting</a>
                <a class="collapse-item {{ (Request::is('admin/join')) ? 'active' : '' }}" href="/admin/join">Join Meeting</a>
                <a class="collapse-item {{ (Request::is('admin/meeting-history')) ? 'active' : '' }}" href="/admin/meeting/history">Meeting History</a>
            </div>
        </div>
    </li>
