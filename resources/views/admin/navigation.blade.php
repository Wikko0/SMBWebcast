<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ (Request::is('admin/meeting')) || (Request::is('admin/meeting/history'))  ? 'active' : '' }}" >
        ...
        <div id="collapseMeeting" class="collapse {{ (Request::is('admin/meeting')) || (Request::is('admin/meeting/history')) ? 'show' : '' }}" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
