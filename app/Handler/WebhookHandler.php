...
class WebhookHandler extends ProcessWebhookJob
{
    ...
    public function handle()
    {
        ...
        if(isset($object['data']['order'])) {
            $productName = $object['data']['order']['products'][0]['title'];
            if($productName == "SMBwebcast Pro Lifetime Plan") {
                $cancellation_link = "https://live.smbwebcast.com/";
                $startTime = time();
                $endTime = strtotime("+100 years");
